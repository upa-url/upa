...
curl -fsS -o %p%\doctest\doctest.h https://raw.githubusercontent.com/doctest/doctest/v2.5.1/doctest/doctest.h
...
curl -fsS -o %p%\srell\srell.hpp https://raw.githubusercontent.com/upa-url/srell/refs/tags/v2026.01/srell-src/single-header/srell.hpp
