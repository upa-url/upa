...
const unsigned char kSharedCharTypeTable[0x100] = {
    ...
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x29  )
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x2a  *
    ...
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEC | CHAR_OCT | CHAR_DEFAULT,  // 0x33  3
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEC | CHAR_OCT | CHAR_DEFAULT,  // 0x34  4
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEC | CHAR_OCT | CHAR_DEFAULT,  // 0x35  5
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEC | CHAR_OCT | CHAR_DEFAULT,  // 0x36  6
    ...
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEFAULT,  // 0x44  D
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEFAULT,  // 0x45  E
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEFAULT,  // 0x46  F
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x47  G
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x48  H
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x49  I
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x4a  J
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x4b  K
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x4c  L
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x4d  M
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x4e  N
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x4f  O
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x50  P
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x51  Q
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x52  R
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x53  S
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x54  T
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x55  U
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x56  V
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x57  W
    ...
    CHAR_QUERY,  // 0x60  `
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEFAULT,  // 0x61  a
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEFAULT,  // 0x62  b
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEFAULT,  // 0x63  c
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEFAULT,  // 0x64  d
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEFAULT,  // 0x65  e
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_HEX | CHAR_DEFAULT,  // 0x66  f
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x67  g
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x68  h
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x69  i
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x6a  j
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x6b  k
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x6c  l
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x6d  m
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x6e  n
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x6f  o
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x70  p
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x71  q
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x72  r
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x73  s
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x74  t
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x75  u
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x76  v
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x77  w
    CHAR_QUERY | CHAR_USERINFO | CHAR_IPV4 | CHAR_DEFAULT,  // 0x78  x
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x79  y
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x7a  z
    CHAR_QUERY,  // 0x7b  {
    CHAR_QUERY | CHAR_DEFAULT,  // 0x7c  |
    CHAR_QUERY,  // 0x7d  }
    CHAR_QUERY | CHAR_USERINFO | CHAR_DEFAULT,  // 0x7e  ~
    0,           // 0x7f
