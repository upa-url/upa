...
const code_point_set path_no_encode_set = {
    0x00, 0x00, 0x00, 0x00, 0xf2, 0xff, 0xff, 0x2f, 0xff, 0xff, 0xff, 0xbf, 0xfe, 0xff, 0xff, 0x57
};
const code_point_set raw_path_no_encode_set = {
    0x00, 0x00, 0x00, 0x00, 0xd2, 0xff, 0xff, 0x2f, 0xff, 0xff, 0xff, 0xbf, 0xfe, 0xff, 0xff, 0x57
};
const code_point_set posix_path_no_encode_set = {
    0x00, 0x00, 0x00, 0x00, 0xd2, 0xff, 0xff, 0x2b, 0xff, 0xff, 0xff, 0xaf, 0xfe, 0xff, 0xff, 0x47
};
